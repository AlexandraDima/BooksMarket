module.exports = dbObject => {
  ...
  router.get("/:categoryId/books/:bookId", (request, response) => {
    ...
    dbObject.getBook(request.params.categoryId,request.params.bookId).then(book => response.json(book));
  });
  ...
  router.post("/:categoryId/books", (request, response) => {
    ...
    dbObject
      .postBook(request.params.categoryId, request.body) // request.body is an answer object
